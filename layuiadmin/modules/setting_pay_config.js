layui.define(['table', 'form', 'op_common'], function (exports) {
    ...
    var apiLists = layui.api.pay_config_get_pay_config_lists;
    var apiCreate = layui.api.pay_config_create_pay_config;
    var apiUpdate = layui.api.pay_config_update_pay_config;
    var apiDelete = layui.api.pay_config_delete_pay_config;
    ...
    table.render({
        ...
        cols: [[
            ...
            {field: 'type', title: '类型', minWidth: 100, templet: '#tpl_type'},
            {field: 'title', title: '标题', minWidth: 100},
            {field: 'desc', title: '备注', minWidth: 100},
            {field: 'is_product', title: '是否正式', templet: '#tpl_is_product'},
